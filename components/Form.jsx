...
export default function Form() {
  ...
  return (
    ...
    >
      {/* Birth Weight */}
      <div>
        <div className="text-white text-lg mb-1">Birth Weight</div>
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              <input
                ...
                name="birth-lbs"
                id="birth-lbs"
                className="block w-full rounded-md border-gray-300 pl-2 pr-12 focus:border-indigo-500 focus:ring-indigo-500 text-3xl"
                // placeholder="Enter lbs"
                aria-describedby="birth-lbs"
                {...register("birthLbs", { required: true })}
              />
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                <span className="text-gray-500 sm:text-lg" id="birth-lbs">
                  lbs
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              />
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                <span className="text-gray-500 sm:text-lg" id="birth-oz">
                  oz
                </span>
              </div>
            </div>
      ...
      {/* Current Weight */}
      <div>
        <div className="text-white text-lg mb-1 mt-6">Current Weight</div>
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label
              htmlFor="current-lbs"
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              />
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                <span className="text-gray-500 sm:text-lg" id="current-lbs">
                  lbs
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              />
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                <span className="text-gray-500 sm:text-xl" id="current-oz">
                  oz
                </span>
              </div>
            </div>
      ...
      <div className="mt-8 text-center">
        <div>
          <button
            type="submit"
            className="w-full flex justify-center items-center rounded-md border border-transparent bg-indigo-100 px-4 py-2 text-xl font-medium text-indigo-700 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 uppercase tracking-wide"
          >
            Calculate Change
          </button>
        </div>
        <div>
          <button
            type="button"
            className="inline-flex items-center text-gray-200 text-base hover:text-gray-300 shadow-sm mt-3"
            onClick={() => {
